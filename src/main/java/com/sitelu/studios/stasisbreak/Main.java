...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        sceneAdmin.setChoices(
                ...
                sceneAdmin, 0, 0,
                "Menemukan Captain’s Access Card disimpan rapat di dalam dokumen",
                "Captain’s Access Card", null,
                0, 0, null,
                null,
                null,
        ...
        sceneCrewCryo.setChoices(
                ...
                null, null,
                5, 16, "Toolbox, Captain’s Access Card",
                Map.of(),
        ...
        sceneMaintenance.setChoices(
                "B", false,
                "Isi Ulang Power Cell",
                sceneMaintenance, 0, 1,
                "Mengisi ulang Power Cell, siap digunakan untuk reaktor. Power Cell terpakai setelah ini",
                null, "Power Cell",
                0, 0, null,
                Map.of("hasPowerCell", true, "PowercellCharged", false),
                "Butuh Power Cell belum terisi",
                Map.of("PowercellCharged", true));

        sceneMaintenance.setChoices(
                "B", true,
                "Power Cell sudah terisi",
                sceneMaintenance, 0, 0,
        ...
        sceneEngineElectrical.setChoices(
                "C", false,
                "Kotak penyimpanan (ambil Power Cell)",
                sceneEngineElectrical, 0, 0,
                "Menemukan Power Cell cadangan di kotak logam tersegel",
                "Power Cell", null,
                0, 0, null,
                Map.of("hasPowerCell", false),
                "Hanya bisa ambil satu Power Cell",
        ...
        sceneEngineElectrical.setChoices(
                ...
                sceneEngineElectrical, 0, 0,
                "Kotak penyimpanan sudah kosong, Power Cell sudah diambil",
                null, null,
                0, 0, null,
                Map.of("hasPowerCell", true),
                null,
        ...
        sceneReactorCore.setChoices(
                ...
                "Butuh Aurora awake, XP≥10, Power Cell, dan Toolkit",
                null);
